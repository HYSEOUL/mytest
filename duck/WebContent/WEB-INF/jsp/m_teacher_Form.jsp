	...
	<form class="form-horizontal" method="post" class="register" action="m_teacher_create" id="m_teacher_create"
		...
		<div class="container ">
			...
			<div class="form-group">
				<div>
				<label>성별</label>
				<input type="text" name="mt_gender" id="mt_gender" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				<div>
				<label>이메일</label>
				<input type="text" name="mt_email" id="mt_email" class="form-control">
				</div>
			</div>	
...
$(function(){
   ...
   $('#idChkBtn').click(function(){
      $.ajax({
         url:"idconfirm/idcheck?mt_id="+$('#mt_id').val(),
