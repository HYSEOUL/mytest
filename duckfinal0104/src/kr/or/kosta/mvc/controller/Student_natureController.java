...
public class Student_natureController {
	...
	// 성향입력 폼으로 이동
	@GetMapping("/student_nature_Insert")
	public String m_studentReg(HttpSession session) {
		String ms_id = (String) session.getAttribute("ms_id");
		System.out.println("student_nature_Insert ->- mypage_student_nature_Form : "+ms_id);
		return "mypage_student_nature_Form";
	}
	...
	public String m_studentModify(HttpSession session, HttpServletRequest request) throws Exception {
		...
		return "mypage_student_nature_update_Form";
	}
	...
	// 성향변경
		...
		public String m_studentModifySend(HttpSession session, 
			...
			return "redirect:/mypage_student_nature";
		}
