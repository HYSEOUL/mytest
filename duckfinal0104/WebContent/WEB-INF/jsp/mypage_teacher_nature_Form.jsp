	...
	<div class="row">
		<div class="col-sm-6">
			<form method="post" action="teacher_nature_Create"> 
					...
					<div>
						<label>1) 자기 성향 선택</label> <select name="tn_my" id="tn_my" class="custom-select">
				...
				<div class="form-group">
					<div>
						<label>3) 학습 서비스 분야 선택</label> <select name="tn_category" id="tn_category" class="custom-select">
