...
<div class="container" style="padding: 5px;">
	<div class="mypageInfo-box">
		<div class="mypageInfo-left">
			<img src="resources/images/${mtvo.mt_img}" class="mypageInfo-img">
			<nav>
				<br>
				<p>
					회 원 명 : ${mtvo.mt_name}<br>
				</p>
				...
				<c:if test="${not empty tmvo }">
					<p>
						포 인 트 : ${tmvo.tm_point}원<br>
					</p>
				</c:if>
				<c:if test="${empty tmvo }">
					<p>
						<a href="creatS_mileage">포인트 생성하기</a>
					</p>
				</c:if>
			</nav>
			<br>
			<button type="submit" id="myInfo" class="btn btn-primary btn-block">상세정보</button>
			<button type="submit" id="myInfoupdate"
				class="btn btn-primary btn-block">정보수정</button>
		</div>

		<div class="mypageInfo-right-calendar">
			<!-- 달력 -->
			<div id="pnlEventCalendar"
				style="border: 5px solid green; paddig: 0px; margin-top: 10px; width: 500px;">
				<script>
					$(function() {
