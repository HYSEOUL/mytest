		...
		<div class="container">
			...
			<div class="form-group">
				<div>
					...
					<select name="c_pnum" id="c_pnum" class="custom-select" >
						<option value="${cvo.c_pnum}">기존 : ${cvo.c_pnum}</option>
			...
			<div class="form-group">
				<div>
					...
					<option value="${cvo.c_loc1}">기존 : ${cvo.c_loc1}</option>
			...
			<div>
					...
					<option value="${cvo.c_category}">기존 : ${cvo.c_category}</option>
			...
			<div>
					...
					<option value="${cvo.c_price}">기존 : ${cvo.c_price}</option>
			...
			<div class="form-group">
					...
					<option value="${cvo.c_count}">기존 : ${cvo.c_count}</option>
			...
			<div class="form-group">
					...
					<select name="c_point" id="c_point" class="custom-select">					
						<option value="${cvo.c_point }">기존 : ${cvo.c_point }</option>
						<option>1</option>
						<option>2</option>
					</select>
			</div>
