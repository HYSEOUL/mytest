	...
	<form class="form-horizontal" method="post" class="register" action="m_student_create" id="m_student_create"
		...
		<div class="container" style="margin-top:30px;">
			<div class="col-sm-8">
				<div>
					<label>채팅방 이름</label>
					<input type="text" name="chatroom_num" id="chatroom_num" class="form-control">
				</div>
			...
			<div>
					...
					<select name="chatroom_category" id="chatroom_category" class="custom-select">
			...
			<div class="col-sm-8">
				...
				<!-- <input type="text" name="ms_name"
					...
					<input type="text" name="ms_name"
					id="ms_name" required="required" class="form-control">
				</div>
			</div>
			<br>
			...
			<div>
				<label>성별</label>
				<select name="ms_gender" id="ms_gender" class="custom-select">
			...
			<div class="col-sm-8">
				<div>
					<input type="submit" class="btn btn-primary btn-block" value="방생성하기">
				</div>
			</div>
		</div>
	</form>
