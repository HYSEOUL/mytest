...
public class C1_reviewVO {
	private int c1_num; // 강의 리뷰 인덱스
	private int c_num; // 리뷰를 찾아 갈강의 글 인덱스
	private String c1_writer; // 리뷰 작성자
	private String c1_reply; // 강의 댓글 내용 (수정)
	private String c1_date; // 댓글 생성 날짜 (수정)
	int c1_stars; // 댓글 별점
